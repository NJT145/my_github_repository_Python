...
# create dictionary dataset where urls are key and values are tags and their values
def openFile(filename):
    ...
    with open(filename) as openfile:
        for line in openfile:
            ...
            line[-1] = line[-1].strip()#default input whitespace char  # .strip("\r\n")
...
# creaate a dataset of matrix
def createDataset(filename):
    datadictionary = openFile(filename)
    out_file = file("bookmarkdataset.txt", "w")
    out_file.write("Urls")
    wordlist = []
