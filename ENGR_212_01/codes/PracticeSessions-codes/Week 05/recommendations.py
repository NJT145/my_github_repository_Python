...
# print loadMovieGenre("u.item")
prefs=loadMovieGenre("u.item")
# for genre in ["Adventure","Drama","Thriller"]:

print topMatches(prefs,person="Adventure",similarity=sim_jaccard)
